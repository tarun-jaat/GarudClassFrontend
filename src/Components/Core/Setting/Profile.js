...
export default function Profile() {
  ...
  return (
    <div className="">
      <p className="text-4xl mb-4 text-richblack-700 font-semibold">Profile</p>
      <ChangeProfile/>
      <form onSubmit={handleSubmit(submitProfileForm)}>

        {/* Profile Information */}
        <div className="my-10 flex flex-col gap-y-6 rounded-md bg-white p-8 px-12">

          <h2 className="text-lg font-semibold text-[#4880FF]"> Profile Information </h2>
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              {errors.firstName && ( <span className="-mt-1 text-[12px] text-pink-100"> Please enter your first name. </span> )}
            </div>
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              {errors.lastName && ( <span className="-mt-1 text-[12px] text-pink-100">  Please enter your last name. </span> )}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              />
              {errors.dateOfBirth && (<span className="-mt-1 text-[12px] text-pink-100">  {errors.dateOfBirth.message}</span>)}
            </div>
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              {errors.gender && ( <span className="-mt-1 text-[12px] text-pink-100"> Please enter your Date of Birth.</span> )}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              />
              {errors.contactNumber && (<span className="-mt-1 text-[12px] text-pink-100">  {errors.contactNumber.message}  </span>  )}
            </div>
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              />
              {errors.about && (<span className="-mt-1 text-[12px] text-pink-100"> Please enter your About. </span>)}
            </div>
          </div>
        ...
        <div className="flex justify-end gap-2">
          <button onClick={() => {navigate("/dashboard/setting") }} className="cursor-pointer rounded-md bg-white py-2 px-5 border-2 border-[#4880FF] font-semibold text-[#4880FF]" >
            Cancel
          </button>
