...
export default function Card() {
  return (
    <>
    <div className={`relative border shadow-xl shadow-richblack-100  border-richblack-300 bg-opacity-15 h-fit w-full mx-3 md:mx-0  md:w-[450px] hover:bg-opacity-30 p-4 rounded-s-3xl flex flex-col justify-between  gap-3`}>
