    ...
    <div className="w-full mx-4 ">
      ...
      {showOptions && (
        <div className="flex flex-col items-center mt-4 text-richblack-700 gap-3 rounded-lg">
          ...
          // className="h-4 border-2 border-blue-100 w-[300px] p-3 py-3 rounded-lg text-black"
            value={correctAnswer}
          ...
          <button className="bg-blue-200 px-3 rounded-lg hover:scale-90 py-2 text-white font-bold w-fit" onClick={handleCreateQuestion}>Create question</button>
        </div>
      )}
