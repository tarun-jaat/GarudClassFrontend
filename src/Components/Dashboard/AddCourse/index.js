  ...
  return (
    <>
      <div className="flex  w-full items-start gap-x-6">
        ...
        {/* Course Upload Tips */}
        <div className="sticky top-24 max-w-[400px] flex-1 rounded-md border-[1px] border-richblack-700 bg-[#4880FF] p-6 hidden lg:block">
          <p className="mb-2 text-lg font-bold text-white">⚡ Course Upload Tips</p>
