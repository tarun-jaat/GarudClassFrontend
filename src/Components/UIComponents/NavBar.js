...
function Navbar() {
  ...
  return (
    <div
      className=" top-10 inset-x-0 max-w-2xl mx-auto z-50"
    >
      <Menu setActive={setActive}>
        <MenuItem setActive={setActive} active={active} item="Study Material">
          <div className="flex text-black flex-col space-y-4 text-sm">
        ...
        <MenuItem setActive={setActive} active={active} item="Menu">
          <div className="flex text-black flex-col text-mono space-y-4 text-sm">
            <HoveredLink href="/hobby">About Us</HoveredLink>
            <HoveredLink href="/individual">Contact us</HoveredLink>
            <HoveredLink href="/team">Blogs</HoveredLink>
            <HoveredLink href="/enterprise">Carrier</HoveredLink>
          </div>
        </MenuItem>
