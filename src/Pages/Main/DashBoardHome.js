  ...
  return (
    <div className="md:p-6 px-2 h-screen w-full ">
      <div className="md:px-4">
        ...
        {user?.accountType === "Instructor" && <Instructor />}
        {user?.accountType === "Student" && <UserBanner />}
        <div className="details flex justify-between mt-2 gap-4 w-full">
          {user?.accountType === "Student" && (
